...
export class WorkflowUtils {
  ...
  static isSimpleStep (step: Step): boolean {
    try {
      ...
      return simpleStep.template !== undefined ||
  ...
  static isWorkflowStep (step: Step): boolean {
    try {
      ...
      return workflowStep.steps !== undefined ||
  ...
  static jsonataPromise (expr: jsonata.Expression, data: any, bindings: Record<string, any>): Promise<any> {
